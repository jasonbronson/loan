...
class CustomPostTypes {
  ...
  public function customPostTypeMenu(){
    add_menu_page( 'Custom Posts', 'Custom Posts', 'edit_posts', 'custom_posts', '', 'dashicons-admin-post', 6 );
  }
   ...
   */
  public function registerCustomPostType( $post_type, $label, $plural, $atts, $slug, $supports = null ) {
    $defaults = array(
      'labels' => array(
        'name' => __( $label ),
